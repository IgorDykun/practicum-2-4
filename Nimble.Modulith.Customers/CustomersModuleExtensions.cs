...
{
    public static IHostApplicationBuilder AddCustomersModuleServices(this IHostApplicationBuilder builder, Microsoft.Extensions.Logging.ILogger logger)
    {
        builder.AddSqlServerDbContext<CustomersDbContext>("customersdb");
        builder.Services.AddScoped(typeof(IRepository<>), typeof(EfRepository<>));
        builder.Services.AddScoped(typeof(IReadRepository<>), typeof(EfRepository<>));

        logger.LogInformation("Customers module services registered");
        return builder;
    }
